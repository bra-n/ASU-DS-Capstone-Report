...
\begin{titlepage}
	\centering
	\includegraphics[width=0.6\textwidth]{Graphics/ASU_Logo.png}\par
	\vspace{2cm}
	...
	%%%% AUTHOR(S)
	{\Large\itshape Robert Lee,\\ Noah McLeod,\\ Brandon Switalski\\}\par
	\vspace{1.5cm}
...
\begin{keywords}
\centering
        \textbf{Capstone; Data Science; Arizona State University}
\end{keywords}
